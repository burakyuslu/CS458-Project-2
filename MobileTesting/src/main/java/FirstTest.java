...
public class FirstTest {
    ...
    public void checkForValidInput2() {
        ...
        System.out.println(
                driver.findElements(By.id("sideEffects"))
        );
        WebElement sideEffectTextField = driver.findElements(By.id("sideEffects")).get(0);
        sideEffectTextField.sendKeys("No");

        System.out.println(sideEffectTextField.getText().toString());

        WebElement third_vacc_radio = driver.findElements(By.id("thirdNo")).get(0);
        third_vacc_radio.click();

        scroll(scrollView,0, 600);
    ...
    public void scroll(WebElement scrollView, int x, int y) {
